// Program to create a Facade Pattern with C# in Visual Studio.
// Programmer : Ashwin Pillai

namespace _10_FacadePattern
{
    /*
   ...
   */
    ...
    class FacadeExample
    {
        ...
        {
            Console.WriteLine("Program to create a Facade Pattern with C# in Visual Studio.\n");
