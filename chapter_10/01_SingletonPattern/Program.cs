// Program to create a Singleton Pattern with C# in Visual Studio.
...
namespace _01_SingletonPattern
{
    ...
    internal class Program
    {
        ...
        {
            Console.WriteLine("Program to create a Singleton Pattern with C# in Visual Studio.\n");
...
First checks if _instance is null. If true, it locks the block of code and checks again before instantiating, 
