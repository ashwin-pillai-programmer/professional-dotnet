// Program to create a Proxy Pattern with C# in Visual Studio.
// Programmer : Ashwin Pillai

namespace _12_ProxyPattern
{
    /*
    ...
    */
    ...
    class Program
    {
        ...
        {
            Console.WriteLine("Program to create a Proxy Pattern with C# in Visual Studio.\n");
