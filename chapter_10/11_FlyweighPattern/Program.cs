// Program to create a Flyweigh Pattern with C# in Visual Studio.
// Programmer : Ashwin Pillai

namespace _11_FlyweighPattern
{
    /*
   Definition
   ...
   */
    ...
    class Program
    {
        ...
        {
            Console.WriteLine("Program to create a Flyweigh Pattern with C# in Visual Studio\n");
