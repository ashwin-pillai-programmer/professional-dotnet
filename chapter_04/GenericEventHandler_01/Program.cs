// Program to demonstrate Generic Event Handler in C# with Visual Studio
...
namespace GenericEventHandler_01
{
    ...
    class Program
    {
        ...
        {
            Console.WriteLine("Program to demonstrate Generic Event Handler in C# with Visual Studio.\n");
